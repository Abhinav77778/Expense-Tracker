  ...
  const handleSubmit = (e) => {
    ...
    if (found) {
      if (found.password === cleanPass) {
        ...
        // 🔥 ADD THIS — Required for ProtectedRoute
    ...
    <div
      className={`flex items-center justify-center h-screen transition-all duration-500 ${
        darkMode
          ...
          : "bg-gradient-to-r from-blue-400 via-purple-200 to-indigo-300"
      }`}
    >
      <button
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`mt-1 w-full rounded-xl shadow-lg p-2 ${
                darkMode ? "bg-gray-800 text-white border-gray-700" : "border border-gray-300"
              }`}
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-2 rounded-xl transition hover:scale-105"
          >
            Sign In
          </button>
          ...
          <a
            href="/signup"
            className="text-blue-600 dark:text-indigo-400 hover:underline block text-center mt-4"
          >
